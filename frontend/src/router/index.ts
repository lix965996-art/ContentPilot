    ...
    },
    {
      ...
      children: [
        ...
        },
        {
          ...
          meta: { roles: ['ADMIN', 'OPERATOR'], title: '媒体' },
        },
        {
          path: 'recommendation',
          name: 'recommendation',
        ...
        },
        {
          ...
          meta: { roles: ['ADMIN', 'OPERATOR', 'VIEWER'], title: '日历' },
        },
        {
          path: 'publish',
          name: 'publish',
        ...
        },
        {
          ...
          meta: { roles: ['ADMIN', 'OPERATOR', 'VIEWER'], title: '数据' },
        },
        {
          path: 'experiments',
          name: 'experiments',
          component: () => import('@/pages/ExperimentsPage.vue'),
          meta: { roles: ['ADMIN', 'OPERATOR'], title: '实验' },
        },
        {
          path: 'settings',
          name: 'settings',
